...
HD_PWD='D:/VProject/test-2/test-2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_smg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_smg.tcl
