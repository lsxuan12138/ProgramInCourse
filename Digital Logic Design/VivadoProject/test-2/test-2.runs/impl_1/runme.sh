...
HD_PWD='D:/VProject/test-2/test-2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_smg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_smg.tcl -notrace
