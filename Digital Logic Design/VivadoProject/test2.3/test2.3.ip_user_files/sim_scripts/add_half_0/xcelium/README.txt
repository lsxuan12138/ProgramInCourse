...
#
# Generated by export_simulation on Wed Oct 20 21:21:56 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './add_half_0.sh' script.

./add_half_0.sh -reset_run
...
./add_half_0.sh -noclean_files

For more information on the script, please type './add_half_0.sh -help'.
