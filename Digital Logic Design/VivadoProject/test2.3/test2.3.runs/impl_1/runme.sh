...
HD_PWD='D:/VProject/test2.3/test2.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_full.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_full.tcl -notrace
