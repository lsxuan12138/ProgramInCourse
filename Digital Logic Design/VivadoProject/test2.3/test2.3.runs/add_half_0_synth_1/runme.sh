...
HD_PWD='D:/VProject/test2.3/test2.3.runs/add_half_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_half_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_half_0.tcl
