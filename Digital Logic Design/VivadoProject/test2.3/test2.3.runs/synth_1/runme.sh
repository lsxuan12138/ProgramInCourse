...
HD_PWD='D:/VProject/test2.3/test2.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_full.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_full.tcl
