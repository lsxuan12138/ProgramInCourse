...
#
# Generated by export_simulation on Wed Dec 01 01:28:29 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './divClk_0.sh' script.

./divClk_0.sh -reset_run
...
./divClk_0.sh -noclean_files

For more information on the script, please type './divClk_0.sh -help'.
