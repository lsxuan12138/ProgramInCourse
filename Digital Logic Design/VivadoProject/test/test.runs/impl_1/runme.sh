...
HD_PWD='D:/VProject/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_mc.tcl -notrace
