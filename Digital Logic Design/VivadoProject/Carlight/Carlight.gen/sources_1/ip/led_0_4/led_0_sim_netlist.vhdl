...
-- Date        : Wed Dec  1 16:30:35 2021
-- Host        : MateBook14 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/VProject/Carlight/Carlight.gen/sources_1/ip/led_0_4/led_0_sim_netlist.vhdl
-- Design      : led_0
...
architecture STRUCTURE of led_0_settime is
  ...
  attribute SOFT_HLUTNM of \c1[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \c1[1]_i_1\ : label is "soft_lutpair0";
...
begin
  ...
  a_0_sp_1 <= a_0_sn_1;
\c1[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B4"
    )
        port map (
...
\ledtemp[7]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DE00"
        ...
        port map (
      I0 => \^q\(3),
      I1 => \ledtemp[7]_i_6_n_0\,
      I2 => \count_reg[0]\,
      I3 => a(0),
      O => \ledtemp[7]_i_4_n_0\
    );
\ledtemp[7]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of led_0_led is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count[1]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \count[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ledtemp[0]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ledtemp[2]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ledtemp[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ledtemp[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ledtemp[5]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ledtemp[5]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ledtemp[6]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ledtemp[6]_i_3\ : label is "soft_lutpair2";
...
\ledtemp[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\ledtemp[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2F2F2F20"
    )
        port map (
...
\ledtemp[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF04"
    )
        port map (
...
\ledtemp[5]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\ledtemp[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0008"
    )
        port map (
      I0 => \^q\(5),
      I1 => \ledtemp[6]_i_4_n_0\,
      I2 => \^q\(3),
      I3 => a(0),
...
\ledtemp[6]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\ledtemp[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\ledtemp[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
s: entity work.led_0_settime
     port map (
      ...
      \a[0]_2\ => s_n_13,
      a_0_sp_1 => s_n_10,
      \count_reg[0]\ => \count_reg_n_0_[3]\,
      \count_reg[0]_0\ => \count_reg_n_0_[2]\,
      \count_reg[0]_1\ => \count_reg_n_0_[1]\,
      \count_reg[0]_2\ => \count_reg_n_0_[0]\,
      \count_reg[1]\ => \count[1]_i_2_n_0\,
      \count_reg[2]\ => \count[2]_i_2_n_0\,
      \ledtemp_reg[0]\ => \ledtemp[0]_i_2_n_0\,
      \ledtemp_reg[0]_0\ => \ledtemp[7]_i_3_n_0\,
      ...
      \ledtemp_reg[7]\ => \ledtemp[7]_i_2_n_0\,
      switch => switch,
      up => up
    );
end STRUCTURE;
