...
#
# Generated by export_simulation on Wed Dec 01 16:29:40 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './number_0.sh' script.

./number_0.sh -reset_run
...
./number_0.sh -noclean_files

For more information on the script, please type './number_0.sh -help'.
