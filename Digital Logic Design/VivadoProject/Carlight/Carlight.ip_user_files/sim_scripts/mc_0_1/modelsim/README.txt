...
#
# Generated by export_simulation on Tue Nov 30 22:37:09 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './mc_0.sh' script.
...
./mc_0.sh -noclean_files

For more information on the script, please type './mc_0.sh -help'.
