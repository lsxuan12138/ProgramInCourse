...
HD_PWD='D:/VProject/Carlight/Carlight.runs/led_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_0.tcl
