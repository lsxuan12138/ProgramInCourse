...
HD_PWD='D:/VProject/Carlight/Carlight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CenterController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CenterController.tcl
