...
HD_PWD='D:/VProject/Carlight/Carlight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CenterController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CenterController.tcl -notrace
