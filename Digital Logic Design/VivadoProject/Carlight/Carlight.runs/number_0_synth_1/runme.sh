...
HD_PWD='D:/VProject/Carlight/Carlight.runs/number_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log number_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source number_0.tcl
