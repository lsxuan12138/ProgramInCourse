...
HD_PWD='D:/VProject/Carlight/Carlight.runs/divClk_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divClk_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divClk_0.tcl
