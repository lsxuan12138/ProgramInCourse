...
#
# Generated by export_simulation on Fri Oct 29 19:03:50 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './D_beat.sh' script.
...
./D_beat.sh -noclean_files

For more information on the script, please type './D_beat.sh -help'.
