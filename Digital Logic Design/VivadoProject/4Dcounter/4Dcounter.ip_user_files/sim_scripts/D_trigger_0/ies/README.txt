...
#
# Generated by export_simulation on Tue Oct 26 19:26:27 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './D_trigger_0.sh' script.

./D_trigger_0.sh -reset_run
...
./D_trigger_0.sh -noclean_files

For more information on the script, please type './D_trigger_0.sh -help'.
