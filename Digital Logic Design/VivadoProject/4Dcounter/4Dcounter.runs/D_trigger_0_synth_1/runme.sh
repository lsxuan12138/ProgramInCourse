...
HD_PWD='D:/VProject/4Dcounter/4Dcounter.runs/D_trigger_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_trigger_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_trigger_0.tcl
