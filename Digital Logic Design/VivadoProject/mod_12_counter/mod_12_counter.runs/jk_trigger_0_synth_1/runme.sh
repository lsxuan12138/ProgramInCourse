...
HD_PWD='D:/VProject/mod_12_counter/mod_12_counter.runs/jk_trigger_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jk_trigger_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jk_trigger_0.tcl
