...
#
# Generated by export_simulation on Tue Oct 26 21:52:20 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './jk_trigger_0.sh' script.

./jk_trigger_0.sh -reset_run
...
./jk_trigger_0.sh -noclean_files

For more information on the script, please type './jk_trigger_0.sh -help'.
