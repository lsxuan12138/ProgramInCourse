...
public class Clock {
    //年
    private third.Screen year;
    //月
    private third.Screen month;
    //日
    private third.Screen day;
    //小时
    private third.Screen hour;
    //分钟
    private third.Screen minute;
    //秒
    private third.Screen second;

    //构造方法
    public Clock(int hour, int minute, int second, int year, int month, int day){
        //设置当前时间 及上下限
        this.hour = new third.Screen(hour,0,24);
        this.minute = new third.Screen(minute,0,60);
        this.second = new third.Screen(second,0,60);
        this.year = new third.Screen(year,0,9999);
        this.month = new third.Screen(month,1,13);
